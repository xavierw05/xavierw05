...
This visualization examines the distribution of high-intensity tornadoes (EF3–EF5) across the United States, highlighting regional differences in severe tornado occurrence. State-level rankings were generated by filtering tornado event data in Microsoft Excel based on intensity and summing total events per state. Key observations include:
</p>
